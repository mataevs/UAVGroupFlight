...
void MainWindow::buildCommonWidgets()
{
	...
	if (!controlWidget)
    {
        controlWidget = new QDockWidget(tr("Simulation Control Widget"), this);
        controlWidget->setWidget( new UAVControl(this) );
        controlWidget->setObjectName("UAV_COMMAND_WIDGET");
        addTool(controlWidget, tr("Simulation Control Widget"), Qt::BottomDockWidgetArea);
    }

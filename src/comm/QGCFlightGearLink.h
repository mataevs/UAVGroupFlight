...
//    void setAddress(QString address);
	...
	void setFlightGearMode(float trueHeadingDeg, float targetAltitudeFt, float targetSpeedKt, QString ap_head, QString ap_alt, QString ap_speed, QString rmgr_input, QString rmgr_enable);
    void setHeadingControls(float trueHeadingDeg, float targetAltitudeFt, float targetSpeedKt, QString ap_head, QString ap_alt, QString ap_speed);
	void setRouteManagerCommand(QString rmgr_input, QString rmgr_enable);
	void setSpeedRouteManagerCommand(float speed, QString rmgr_input, QString rmgr_enable);

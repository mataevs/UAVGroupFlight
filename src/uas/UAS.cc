...
void UAS::transmitFlightGearCommand(float trueHeadingDeg, float targetAltitudeFt, float targetSpeedKt, QString ap_head, QString ap_alt, QString ap_speed, QString rmgr_input, QString rmgr_enable) {
	emit hilControlsChanged(trueHeadingDeg, targetAltitudeFt, targetSpeedKt, ap_head, ap_alt, ap_speed, rmgr_input, rmgr_enable);
}

void UAS::transmitHilHeadingCommand(float trueHeadingValue, float targetAltitude, float targetSpeed, QString ap_head, QString ap_alt, QString ap_speed) {
	emit hilHeadingCommand(trueHeadingValue, targetAltitude, targetSpeed, ap_head, ap_alt, ap_speed);
}

void UAS::transmitHilRouteManagerCommand(QString rmgr_input, QString rmgr_enable) {
	emit hilRouteManagerCommand(rmgr_input, rmgr_enable);
}

void UAS::transmitHilSpeedRouteManagerCommand(float speed, QString rmgr_input, QString rmgr_enable) {
	emit hilSpeedRouteManagerCommand(speed, rmgr_input, rmgr_enable);
}

...
public slots:
	...
	void transmitFlightGearCommand(float trueHeadingDeg, float targetAltitudeFt, float targetSpeedKt, QString ap_head, QString ap_alt, QString ap_speed, QString rmgr_input, QString rmgr_enable);
	void transmitHilHeadingCommand(float trueHeadingValue, float targetAltitude, float targetSpeed, QString ap_head, QString ap_alt, QString ap_speed);
	void transmitHilRouteManagerCommand(QString rmgr_input, QString rmgr_enable);
	void transmitHilSpeedRouteManagerCommand(float speed, QString rmgr_input, QString rmgr_enable);
